...
class SimpleHumanChat:
    ...
    def _init_human_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            # 普通の返事パターン
            'いいよ': ['よかった', 'そっか', 'いいね', 'そうなんだ'],
            'いい': ['よかった', 'そっか', 'いいね', 'そうなんだ'],
            'よい': ['よかった', 'そっか', 'いいね'],
            'よかった': ['よかったね', 'いいね', 'そっか', 'うん'],
            ...
            # 今日系の質問への応答
            '今日の予定': ['今日何するの？', '予定あるの？', 'どんな一日？', '忙しい？'],
            'きょうの予定': ['今日何するの？', '予定あるの？', 'どんな一日？'],
            '今日': ['今日どうだった？', '今日は何してた？', 'お疲れさま'],
            'きょう': ['今日どうだった？', '今日は何してた？'],
            '予定': ['何する予定？', 'どんな予定？', '忙しそうだね'],
            'よてい': ['何する予定？', 'どんな予定？'],
            
            # やること・TODO関連
            'やること': ['何かやることあるの？', 'どんなこと？', 'がんばって'],
            'todo': ['何かあるの？', 'どんなやつ？', 'がんばって'],
            'タスク': ['何かタスクあるの？', 'どんなやつ？', 'がんばって'],
    ...
    def is_simple_human_chat(self, text: str) -> bool:
        ...
        # 機能要求・複雑な質問は除外（ただし、普通の会話レベルのやつは含める）
        excluded = [
            'リスト出し', 'リスト表示', '一覧', 'list', '教えて', '説明して', 
            'どうやって', '方法', 'ヘルプ', 'help', '手順', 'やり方', '詳しく'
        ]
