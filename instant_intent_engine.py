...
class InstantIntentEngine:
    ...
    def _initialize_instant_patterns(self):
        ...
        # カジュアル会話系 (高速応答)
        casual_patterns = {
            '元気？': IntentResult('casual', 0.95, 'respond', {}, '元気だよ', 0.001),
            '元気': IntentResult('casual', 0.90, 'respond', {}, '元気だよ', 0.001),
            '調子どう？': IntentResult('casual', 0.95, 'respond', {}, 'まあまあ', 0.001),
            '調子どう': IntentResult('casual', 0.95, 'respond', {}, 'まあまあ', 0.001),
            'どう？': IntentResult('casual', 0.85, 'respond', {}, 'まあまあかな', 0.001),
            'どう': IntentResult('casual', 0.80, 'respond', {}, 'まあまあかな', 0.001),
